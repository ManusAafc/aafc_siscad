  ...
  try {
    ...
    if (profile) {
      return {
        ...
        profileImgPath: profile.profile_img_path || '',
        profileImgName: profile.profile_img_name || '',
        statusId: profile.status_id ?? 1,
        isAdminSuper: toBoolean(profile.is_admin_super),
        ...
        updatedAt: '',
        deletedAt: '',
        dbMemberPlanId: profile.db_member_plan_id ?? 0,
        dbMemberStatusId: profile.db_member_status_id ?? 0,
        isManagerMembers: toBoolean(profile.is_manager_members),
        isManagerMeetings: toBoolean(profile.is_manager_meetings),
      };
    }
  } catch (e) {
